...
class Settings:
    ...
    prices_text: str = (
        "<b>Услуги и цены</b>\n\n"
        "🆓 <b>Пробная тренировка</b> — 1000₽\n\n"
        "🏋️‍♂️ <b>Персональная тренировка</b> — 2500₽\n\n"
        "🥊 <b>Консультация с тренером</b> — 1500₽\n\n"
        "🎟️ <b>Абонементы и пакеты тренировок</b> — по запросу у администратора"
    )
    welcome_text: str = (
    ...
    services: List[ServiceItem] = field(
        default_factory=lambda: [
            ...
            ServiceItem(
                code="personal",
                title="🏋️‍♂️ Персональная тренировка",
                price="2500₽",
